...
Deep learning model which trains on data about 80% of customers and tests with 20% to predict 
whether a customer stopped being a customer of a bank and left.
